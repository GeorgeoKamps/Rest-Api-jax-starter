...
import gr.aueb.cf.jaxstarter4.dto.TeacherUpdateDTO;
...
public class TeacherRestController {
    ...
    public Response getTeachers() {
        ...
        // Assume we call service layer and gat back
        // a list of teachers
        List<Teacher> teachers = Arrays.asList(new Teacher(1L, "123456", "Ath", "Andr."),
                new Teacher(2L,"234567","makis","kap"),
    ...
    public Response getTeacher(@PathParam("teacherId") Long teacherId) {
        // Assume that we call getTeacherById() and
        //we get back a teacher instance or null
        Teacher teacher = new Teacher(teacherId, "123456", "Chris.", "Androutsos");
    ...
    public Response addTeacher(MultivaluedMap<String, String> formParams, @Context UriInfo uriInfo) {
     ...
     public Response deleteTeacher(@PathParam("teacherId") Long teacherId) {
        ...
        // we call deleteTeacher(teacherId) and we get back deleted teacher
     ...
     public Response updateTeacher(@PathParam("teacherId") Long teacherId, MultivaluedMap<String, String> params) {
        ...
        List<String> errors = new ArrayList<>();
        TeacherUpdateDTO teacherUpdateDTO = mapUpdateFromMultiV(params);
    ...
    private TeacherUpdateDTO mapUpdateFromMultiV(MultivaluedMap<String, String> params) {
